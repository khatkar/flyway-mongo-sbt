...
/**
 * Large Test for the MongoFlyway Sbt Plugin.
 */
@SuppressWarnings({"JavaDoc"})
public class MongoSbtLargeTest extends EmbeddedMongoDb {
    private File sbtLaunchJar = new File(System.getProperty("sbtLaunchDir", "./"), "sbt-launch.jar");
    private File installDir = new File(System.getProperty("installDir", "flyway-mongo-sbt-largetest/target"));
